...
export default function App() {
  ...
  useEffect(()=>{
    ...
    // Do not restore a paused track into the mini-player after reload.
    // The player appears only after the user actively starts a song.
